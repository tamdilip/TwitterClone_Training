...
<div class=s>
<csc:if test="hasActionErrors()">
    <h1 >  <csc:actionerror/></h1>
</csc:if>
<csc:form action="Register">
<csc:textfield name="username" label="UserName" id="id2" onkeyup="loadXMLDoc()"/>
<csc:label id="err"></csc:label>
<csc:password name="password" label="Password" />
<csc:textfield name="fullname" label="Full Name" />
<csc:textfield name="email" label="Email" />
<csc:submit type="image" src="images/signup.png" value="" />
</csc:form>
</div>
</body>
